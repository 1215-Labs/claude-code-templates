...
<!-- Adapted from: references/claude-code-hooks-mastery/.claude/agents/team/validator.md on 2026-02-09 -->
...
- You MUST NOT modify files — you are read-only. If something is wrong, report it.
